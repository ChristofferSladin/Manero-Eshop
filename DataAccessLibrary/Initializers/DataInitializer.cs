...
public class DataInitializer
{
    ...
    {
        AddProductIfNotExisting(15, "Blue", "Denim Jacket", "Perfect for casual outings", "Jackets", "Casual", "S", 69.99M, (69.99M * 1.2M), 0.8M, true, false, 4.5M, "https://images.unsplash.com/photo-1615943168243-5b2503679e47?q=80&w=2565&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Men");
        AddProductIfNotExisting(15, "Blue", "Denim Jacket", "Perfect for casual outings", "Jackets", "Casual", "M", 69.99M, (69.99M * 1.2M), 0.8M, true, false, 4.5M, "https://images.unsplash.com/photo-1615943168243-5b2503679e47?q=80&w=2565&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Women");
        ...
        AddProductIfNotExisting(15, "Black", "Denim Jacket", "Perfect for casual outings", "Jackets", "Casual", "M", 69.99M, (69.99M * 1.2M), 0.8M, true, false, 4.5M, "https://images.unsplash.com/photo-1615943168243-5b2503679e47?q=80&w=2565&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Kids");
        AddProductIfNotExisting(15, "Yellow", "Denim Jacket", "Perfect for casual outings", "Jackets", "Casual", "M", 69.99M, (69.99M * 1.2M), 0.8M, true, false, 4.5M, "https://images.unsplash.com/photo-1615943168243-5b2503679e47?q=80&w=2565&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Women");
        AddProductIfNotExisting(15, "Blue", "Denim Jacket", "Perfect for casual outings", "Jackets", "Casual", "L", 69.99M, (69.99M * 1.2M), 0.8M, true, false, 4.5M, "https://images.unsplash.com/photo-1615943168243-5b2503679e47?q=80&w=2565&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Men");
        AddProductIfNotExisting(15, "Red", "Denim Jacket", "Perfect for casual outings", "Jackets", "Casual", "L", 69.99M, (69.99M * 1.2M), 0.8M, true, false, 4.5M, "https://images.unsplash.com/photo-1615943168243-5b2503679e47?q=80&w=2565&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Kids");
        AddProductIfNotExisting(15, "Blue", "Denim Jacket", "Perfect for casual outings", "Jackets", "Casual", "XL", 69.99M, (69.99M * 1.2M), 0.8M, true, false, 4.5M, "https://images.unsplash.com/photo-1615943168243-5b2503679e47?q=80&w=2565&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Women");
        ...
        AddProductIfNotExisting(10, "Green", "Cargo Pants", "Roomy and comfortable", "Pants", "Casual", "L", 49.99M, (49.99M * 1.2M), 0.95M, true, false, 4.3M, "https://images.unsplash.com/photo-1473966968600-fa801b869a1a?q=80&w=2000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", "Kids");
        ...
        AddProductIfNotExisting(77, "Grey", "Stylish Bag", "Perfect for elegant looking ladies", "Bags", "Formal", "M", 89.99M, (89.99M * 1.2M), 0.9M, false, true, 5.0M, "https://images.unsplash.com/photo-1559563458-527698bf5295?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxfDB8MXxyYW5kb218MHx8fHx8fHx8MTY5OTM2NDMyNA&ixlib=rb-4.0.3&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=1080", "Women");
        AddProductIfNotExisting(80, "Golden", "Locket", "Perfect for elegant looking ladies", "Lockets", "Casual", "M", 89.99M, (89.99M * 1.2M), 0.9M, false, true, 5.0M, "https://images.unsplash.com/photo-1611652022419-a9419f74343d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxfDB8MXxyYW5kb218MHx8fHx8fHx8MTY5OTM2NDM2MA&ixlib=rb-4.0.3&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=1080", "Women");
